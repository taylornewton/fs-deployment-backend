...
var getReviews = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var reviewsFound;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, review_1.Review.find({})];
            case 1:
                reviewsFound = _a.sent();
...
var createReview = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var newReview, created, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                newReview = new review_1.Review(req.body);
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (!(req.body.reviewId != req.params.reviewId)) return [3 /*break*/, 1];
                res.status(400).json("Bad Request: reviewId " + req.body.reviewId);
                return [3 /*break*/, 3];
            case 1: return [4 /*yield*/, review_1.Review.findByIdAndUpdate(req.params.reviewId, req.body, {}, function (err) {
                    if (err) {
                        console.log(err);
                        res.status(400);
                    }
...
var deleteReview = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, review_1.Review.findByIdAndDelete(req.params.reviewId, {}, function (err) {
                    if (err) {
                        console.log(err);
                        res.status(400);
                    }
